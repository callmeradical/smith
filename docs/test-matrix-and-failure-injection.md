...
| M-009 | E2E | Ingress modes (GitHub, PRD, interactive attach) | `./scripts/test/e2e-ingress-modes.sh` | Each ingress mode reaches terminal `synced` state and preserves source traceability (`source_type`, `source_ref`) |
